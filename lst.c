...
/**
 * add_node1 - this adds a node to the start of the list
 ...
 * Return: size of list
 */
list_t *add_node1(list_t **head, const char *string, int number)
{
	list_t *new_head;
...
/**
 * add_node_end1 - this adds a node to the end of the list
 * @head: address of pointer to head node
 * @string: string field of node
 * @number: node index used by history
 *
 * Return: size of list
 */
list_t *add_node_end1(list_t **head, const char *string, int number)
{
